...
" Normal Mode:
let s:N1 = [ '#ffff57' , '#003078' , 240 , 254 ] " Mode
let s:N2 = [ '#ffffff' , '#003078' , 254 , 31  ] " Info
let s:N3 = [ '#eeeeee' , '#003078' , 255 , 24  ] " StatusLine
...
" Insert Mode:
let s:I1 = [ '#ffffff' , '#003078' , 240 , 254 ] " Mode
let s:I2 = [ '#e4e4e4' , '#0087af' , 254 , 31  ] " Info
let s:I3 = [ '#eeeeee' , '#003078' , 255 , 24  ] " StatusLine
